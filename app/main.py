...
app = FastAPI(
    ...
    * **Deployments** - Schedule and manage deployments with priority queuing
    ...
    openapi_tags=[{
        ...
        "authentication",
        "description":
        "Operations with user authentication. Register new users and login."
    }, {
        "name":
        "organizations",
        "description":
        "Manage organizations and handle user invitations."
    }, {
        "name":
        "clusters",
        "description":
        "Create and manage compute clusters with resource tracking."
    }, {
        "name":
        "deployments",
        "description":
        "Schedule and manage deployments with priority-based queuing."
    }],
    docs_url="/docs",
    redoc_url="/redoc")
